using eSya.DocumentControl.WebAPI.Filters;
using Microsoft.Extensions.Configuration;
using DL_DocumentControl = eSya.DocumentControl.DL.Entities;
using eSya.DocumentControl.IF;
using eSya.DocumentControl.DL.Repository;
using Microsoft.AspNetCore.Mvc;
using eSya.DocumentControl.WebAPI.Utility;
using System.Globalization;
using eSya.DocumentControl.DL.Localization;
...
DL_DocumentControl.eSyaEnterprise._connString = builder.Configuration.GetConnectionString("dbConn_eSyaEnterprise");
